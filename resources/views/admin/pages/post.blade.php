            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{url('/admin/post/edit/url_key')}}" class="btn btn-app" title="Sửa"><i class="fas fa-edit"></i>Sửa</a>
                        <a href="{{url('/admin/post/del/url_key')}}" class="btn btn-app" title="Xóa"><i class="fas fa-trash-alt"></i>Xóa</a>
